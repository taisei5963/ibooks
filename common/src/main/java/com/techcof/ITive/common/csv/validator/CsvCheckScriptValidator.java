...
import com.techcof.ITive.common.validator.CheckScriptValidator;
 ...
 * 必須ではない
 */
public class CsvCheckScriptValidator extends ValidationCellProcessor implements
        StringCellProcessor {
    /**
     * コンストラクタ
     */
    ...
    public <T> T execute(Object value, CsvContext context) {
        ...
        throw createValidationException(context)
                .messageFormat("値にスクリプトと疑われる文字列が含まれています。")
