...
import jp.techcof.ITive.admin.config.LoginConfig;
import jp.techcof.ITive.admin.dto.AdminDto;
import jp.techcof.ITive.admin.request.LoginForm;
import jp.techcof.ITive.common.database.repository.AdminRepository;
import jp.techcof.ITive.common.exception.LoginLockException;
import jp.techcof.ITive.common.model.AdminModel;
...
public class LoginService {
     ...
     * @return 管理者モデル
     */
    public Optional<AdminModel> getLoginAdmin() {
     ...
     */
    public Optional<AdminModel> login(LoginForm form)
            throws LoginLockException, InterruptedException {
        ...
        if (admin.getLoginFailureCount() >= limit) {
            LocalDateTime lockEnd = admin.getLastLoginDate().plusSeconds(lockSec);
